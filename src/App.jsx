    ...
    <Toaster position="top-right" reverseOrder={false} />
      ...
      <div>
        ...
        <div style={{backgroundImage:`url(${bgimg})`}} className="flex flex-col mb-[50px] md:mb-100px h-[800px] md:flex-row w-full gap-4 px-4 ">
          ...
          <div className="w-full md:w-1/2 pt-4 md:pt-14 order-2 md:order-none">
            <h1 className='font-bold text-4xl text-[#24447c] pt-5 '> Amenities</h1>
            <Amenities/>
          </div>
        </div>
       <div className="p-16 pt-[204px] md:pt-0">
            <h1 className='font-bold text-4xl  text-[#24447c] pt-16 pb-8'> Price Chart</h1>
